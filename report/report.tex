...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=.75\textwidth]{../figures/1_count_donor_ids.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=.75\textwidth]{../figures/0_number_of_samples_barplot.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=.75\textwidth]{../figures/0_number_of_samples_barplot_passing_QC.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=.75\textwidth]{../figures/violintissues_pct_counts_mt.png}
